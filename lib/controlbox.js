...
function setTrees() {
  ...
  for (var i = 0; i < 10; i++) {
    tr.append('td')
      ...
      .html( function(d) {
      if (d + i < full)
        return '<img id="tree" src="../assets/A_Simple_Green_Tree.svg" alt="Tree">';
      else if (d + i < nTrees) {
        return '<img id="tree" style="transform: scale(' + extra + ', ' + extra + ');" src="../assets/A_Simple_Green_Tree.svg" alt="Tree">';
      }
      else {
        return "";
      }
