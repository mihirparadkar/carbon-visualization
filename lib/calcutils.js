...
var AVG_MPH = 60;
var CO2_ABSORPTION_PER_YEAR_LBS = 48;

//return number of trees needed to offset given co2 output / minute
function numTrees(){
  var grams_co2_per_Min = predictCO2(cubic_model);
  var mins_per_day = AVG_MILES_PER_DAY / AVG_MPH;
  var lb_co2_per_day = grams_co2_per_Min * mins_per_day / 1000 * 2.2;
